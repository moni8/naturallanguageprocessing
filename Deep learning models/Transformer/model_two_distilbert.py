...
# This is a Distilbert base uncased fine-tuned version model
# loaded using `from_pretained` method.
model_name = "Zhaohui/finetuning-sentiment-model-imdb"
...
print("type of dataset", emotion_train_dataset)
